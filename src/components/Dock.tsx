...
export default function Dock() {
  const dockItems: { icon: string | React.ElementType, link: string, color: string }[] = [
    { icon: Github, link: "https://github.com", color: "bg-gradient-to-b from-zinc-700 to-zinc-900" },
    { icon: Linkedin, link: "https://linkedin.com", color: "bg-gradient-to-b from-blue-500 to-blue-700" },
